...
<div class="course-card">
	    ...
	    <?php $image = CHtml::image($imgUrl,'image',array('style'=>'width:100%','class'=>'hidden-xs'));
	    	echo CHtml::link($image,array('//course/index/view','id'=>$data->id));?>
	    <div style="border:2px solid #eee;">
	    	<?php echo CHtml::link(mb_substr($data->name,0,32,'utf-8'),array('//course/index/view','id'=>$data->id),array('style'=>"box-sizing:border-box; height:112px; display:block;color:#333;font-size:22px;border-bottom:2px solid #eee;padding:25px;line-height:30px;"));?>
