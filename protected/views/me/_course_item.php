<li class="col-sm-3" courseId="<?php echo $data->id;?>" >
<div class="course-card">
	    ...
	    <?php $image = CHtml::image($imgUrl,'image',array('style'=>'width: 270px;height:200px;','class'=>'hidden-xs'));
	    ...
	    <div style="border:2px solid #eee;border-top:none;">
			...
			<?php echo Yii::t('app','已有 {memberNum} 同学',array('{memberNum}'=>$data->memberNum))?>
			</div>
