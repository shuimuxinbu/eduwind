...
?>
	...
	<h5><?php echo Yii::t('app','搜索');?> "<em><b><?php echo CHtml::link($keyword,"#");?>"</b></em><?php echo Yii::t('app','共得');?> <b><?php echo $dataProvider->totalItemCount;?></b> <?php echo Yii::t('app','条相关结果');?></h5>
	<br/>
