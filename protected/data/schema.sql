...
CREATE TABLE `ew_comment` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=170 DEFAULT CHARSET=utf8 COMMENT='评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='选课成员';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_course_post` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='讨论区帖子';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_entity` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=477 DEFAULT CHARSET=utf8 COMMENT='可挂载对象';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_follow` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=83 DEFAULT CHARSET=utf8 COMMENT='关注表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_lesson` (
  ...
  PRIMARY KEY (`id`),
  KEY `courseId` (`courseId`)
) ENGINE=MyISAM AUTO_INCREMENT=160 DEFAULT CHARSET=utf8 COMMENT='课时表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `ew_member`
--

DROP TABLE IF EXISTS `ew_member`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ew_member` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='用户从属关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_notice` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=100 DEFAULT CHARSET=utf8 COMMENT='提醒，通知';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_post` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='讨论区帖子';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_system_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='系统设置值表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ew_teacher`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='用来记录网站升级包的信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ew_upload_file` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`)
) ENGINE=MyISAM AUTO_INCREMENT=63 DEFAULT CHARSET=utf8 COMMENT='文件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-08-25 22:16:28

insert into AuthItem (name,type,description) values('admin',2,'管理员');
insert into AuthItem (name,type,description) values('teacher',2,'教师');
insert into AuthAssignment (itemname,userid) values('admin',2);

alter table ew_course_member add status int(11) not null default 0;
update ew_course_member set status=1;
rename table ew_teacher to ew_cms_people;
alter table ew_cms_people add face char(255) not null default "";
alter table ew_page add `key` char(255) not null default "";

alter table ew_group add leaderTitle char(255) not null default "组长";
alter table ew_group add memberTitle char(255) not null default "成员";
alter table ew_group add adminTitle char(255) not null default "管理员";

ALTER TABLE `ew_user` ADD `sessionId` CHAR(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '保存用户最近的一个sessionId' ;
ALTER TABLE `ew_user` ADD `lastAccessTime` INT(11) NOT NULL COMMENT '从课程界面最近的一次访问时间' ;

--
-- 表的结构 `ew_course_file`
--

CREATE TABLE IF NOT EXISTS `ew_course_file` (
`id` int(11) NOT NULL,
  `courseId` int(11) NOT NULL,
  `fileId` int(11) NOT NULL,
  `status` char(32) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用于描述某一门课程的视频文件库' AUTO_INCREMENT=2 ;

ALTER TABLE `ew_course_file`
 ADD PRIMARY KEY (`id`);

ALTER TABLE `ew_course_file`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;

alter table ew_course add validTime int(11) not null default 0;
alter table ew_page add `key` char(64) not null default '';

create table ew_log(
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '选票值，1为顶，0为踩',
  `data` int(11) NOT NULL DEFAULT '0' COMMENT '评价者id',
  `addTime` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间',
  primary key(id)
);
...
alter table ew_message add isMailed tinyint(1) not null default 0;
alter table ew_notice add isMailed tinyint(1) not null default 0;
alter table ew_user_info add receiveMailNotify tinyint(1) not null default 0;
...
alter table ew_page add categoryId int(11) not null default 0;

alter table ew_category add addTime int(11) not null default 0;
...
ALTER TABLE `ew_lesson` 
ADD COLUMN `duration` INT NOT NULL DEFAULT 0 AFTER `chapterId`;
