...
class QuizController extends Controller
{
	...
	public function actionView($id)
	{
		...
		//$questionDataProvider = new CActiveDataProvider('Question',array('criteria'=>array('condition'=>"quizId=$quiz->id",'order'=>'weight asc'),'pagination'=>array('pageSize'=>30)));
		$questionDataProvider = new CArrayDataProvider($quiz->questions,array('pagination'=>array('pageSize'=>30)));
		$lesson = $quiz->lesson;
	 ...
	 * Lists all models.
	 */
	public function actionIndex($lessonId)
	{
