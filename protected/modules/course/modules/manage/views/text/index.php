...
<div class="row ">
	...
	<div class="col-sm-10">
		<h3 class="side-lined"><?php echo Yii::t('app','图文内容');?></h3>
		<?php echo CHtml::link('<i class="icon-plus icon-white"></i>'.Yii::t('app','添加内容'),array('question/create','textId'=>$lesson->mediaId),array('class'=>'btn btn-success   mr10'));?>
	</div>
</div>
