...
<div>
	...
	<div>
		<div class="pull-left muted"><small><?php echo Yii::t('app','来自课程***');?></small></div>
		<?php echo CHtml::link(Yii::t('app','回复'),'javascript:;',array('class'=>'muted pull-right','data-toggle'=>'collapse','data-target'=>'#dxd-comment-form-'.$index));?>
