...
//    echo CHtml::link(,array('u/index','id'=>$data->userId),array('class'=>'dxd-name','data-userId'=>$data->userId,'style'=>'margin-top:5px;'));
	...
	echo CHtml::ajaxLink(Yii::t('app','通过申请'),array('groupMember/setMember','groupid'=>$group->id,'userId'=>$data->userId),array('success'=>'js:function(data){window.location.reload();}'),array('class'=>'btn btn-success pull-right'));
	?>
