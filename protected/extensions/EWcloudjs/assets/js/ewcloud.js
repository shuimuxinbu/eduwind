function EwCloudJs() {
    ...
    this.uploader = function(op) {
        ...
        var getUpToken = function() {
            //that.token = 'Pc4FsxhIWOLhu_OU8CYaKj4PVK9qN35VpS74g6lM:JueDj6fbizSypIYYaeSOoHEplfQ=:eyJzY29wZSI6Imh5aHlwcml2YXRlOkNDVFYxLldhdGVyLlB1bHNlLkUwMS43MjBwLkhEVFYueDI2NC5BQUMtaUhELm1wNCIsImRlYWRsaW5lIjoxNDE4ODMxNjY0fQ==';
        ...
        uploader.bind('BeforeUpload', function(up, file) {
            ...
            var directUpload = function(up, file, func) {
                ...
                if (op.save_key) {
                    ...
                    multipart_params_obj = {
                        'key': that.key,//getFileKey(up, file, func),
                        'token': that.token
                    };
                }
            ...
            if (uploader.runtime === 'html5' && chunk_size) {
                if (file.size < chunk_size) {
                    ...
                    up.setOption({
                        'url': 'http://up.eduwind.com/mkblk/' + blockSize,
                        'multipart': false,
        ...
        uploader.bind('ChunkUploaded', function(up, file, info) {
            ...
            if (leftSize < chunk_size) {
                up.setOption({
                    'url': 'http://up.eduwind.com/mkblk/' + leftSize
                });
            }
        ...
        uploader.bind('FileUploaded', (function(_FileUploaded_Handler) {
            return function(up, file, info) {
                ...
                if (ctx) {
                    ...
                    var url = 'http://up.eduwind.com/mkfile/' + file.size + key + x_vars_url;
                    var ajax = that.createAjax();
