...
*/
	class vCard implements Countable, Iterator
	{
		...
		private static function ParseParameters($Key, array $RawParams = null)
		{
			...
			// And each parameter is isChecked whether anything can/should be done because of it
			foreach ($Parameters as $Index => $Parameter)
			{
				...
				if (count($Parameter) == 1)
				{
					...
					// The second part of the "if" statusment means that email elements can have non-standard types (see the spec)
					if (
